...
private const val SWIPE_THRESHOLD_PROPORTION = 0.325F
...
private const val ANIMATION_THRESHOLD_PROPORTION = 0.25F

// The offset to [ANIMATION_THRESHOLD_PROPORTION] where
// the icon starts its "lift" animation
private const val ICON_LIFT_ANIMATION_OFFSET_PROPORTION = 0.1F

// How far into the interactive animation the color change
// should occur
private const val ICON_CHANGE_COLOR_OFFSET_PROPORTION = 0.02F

// The maximum scale of the icon when lifting
// This value must be greater than or equal to 1
private const val MAX_LIFT_SCALE = 1.5F
...
private const val REVEAL_COLOR_CHANGE_DURATION = 100L

// Icon specs
private const val ICON_MARGIN_DP = 32F
private const val ICON_DEFAULT_SIZE_DP = 24F

private const val TIME_PER_FRAME_MS = 1000L / 60L

private typealias ViewHolderCheckCallback = (viewHolder: RecyclerView.ViewHolder) -> Boolean
private typealias ViewHolderNotifyCallback = (viewHolder: RecyclerView.ViewHolder, direction: Covert.SwipeDirection) -> Unit
 ...
 *
 * Covert must be attached to the recyclerView using the [Covert.Builder.attachTo] function. The instance of
 * Covert returned by this function should be passed along to your [RecyclerView.Adapter]. This allows Covert
 * to draw the initial state of any defined [Covert.CornerFlag] on the [RecyclerView.ViewHolder]s itemView.
 * For information around how to implement this, as well as additional optimisations, check the full documentation
 * in the Github repository.
 */
class Covert private constructor(
    ...
    /**
     * Draws the [CornerFlag] on a card from somewhere outside of normal [Covert] swiping operation.
    ...
    /**
     * [Covert.Config] allows you to modify the look and feel of [Covert]. The primary constructor
    ...
    data class Builder(
         ...
         */
        fun attachTo(recyclerView: RecyclerView) = Covert(
                recyclerView,
                config,
